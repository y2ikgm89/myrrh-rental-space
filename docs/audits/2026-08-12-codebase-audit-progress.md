...
**高 11 件は全件クローズ。**残りは中 40 件・低 54 件で、[計画書 §6](../superpowers/plans/2026-08-13-codebase-audit-remediation.md#6-未着手の指摘台帳) の台帳に載っている。
...
| [F-18](2026-08-12-codebase-audit-findings.md#f-18)   | 中     | ★PR                   | /access とカスタムページに Cache-Tag を emit（site-wide の purge が届くように）                  | —                                                                                           |
...
| [F-73](2026-08-12-codebase-audit-findings.md#f-73)   | 中     | ★PR                   | イベント詳細 source の lookahead をセグメント境界に固定                                          | —                                                                                           |
| [F-112](2026-08-12-codebase-audit-findings.md#f-112) | 低     | #2265                 | 匿名化した placeholder を送信対象外にし、リマインダ cron の母集合からも外す                      | —                                                                                           |
| [F-88](2026-08-12-codebase-audit-findings.md#f-88)   | 低     | ★PR                   | イベントページの Cache-Tag に space-v1 / location-v1 を追加                                      | —                                                                                           |
