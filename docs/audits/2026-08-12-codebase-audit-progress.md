...
| [F-104](2026-08-12-codebase-audit-findings.md#f-104) | 低     |                                            | 予約確認の合計を `pricePreview.totalPriceWithTax` + `formatPrice` で描く。STANDARD 再課税をやめた                | SpaceCard / JSON-LD / `resolvePublicDisplayPrice` は範囲外                              |
