...
| [F-79](2026-08-12-codebase-audit-findings.md#f-79)   | 低     | `fix/audit-f79-workflow-paths-flow`        | required-check path filter gate を `Bun.YAML.parse` にし、flow 形式 `paths: [terraform/**]` を検出 | —                                                                                       |
