...
| [F-24](2026-08-12-codebase-audit-findings.md#f-24) | 中     | ★PR                   | 編集ダイアログからの無効化でもパスコードを失効する                                               | —                                                                                           |
| [F-25](2026-08-12-codebase-audit-findings.md#f-25) | 中     | ★PR                   | Pad の直接付け替えで旧 Pad を失効し新 Pad へ発行する                                             | —                                                                                           |
...
| [F-67](2026-08-12-codebase-audit-findings.md#f-67) | 中     | ★PR                   | 再発行の絞り込みを「生きたパスコードが無い」に直す（REVOKED 行で除外されない）                   | —                                                                                           |
| [F-68](2026-08-12-codebase-audit-findings.md#f-68) | 中     | ★PR                   | 拠点変更で Pad を外したときもパスコードを失効する                                                | —                                                                                           |
