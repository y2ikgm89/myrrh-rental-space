...
| [F-119](2026-08-12-codebase-audit-findings.md#f-119) | 低     | —                                          | 非公開 / 非アクティブな Space は会場名だけ出し、`/spaces/<slug>` リンクと JSON-LD `venue.url` を出さない         | createEvent/updateEvent の spaceId 製品判断は未変更                                     |
