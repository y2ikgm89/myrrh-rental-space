...
**高 11 件は全件クローズ。**残りは中 42 件・低 56 件で、[計画書 §6](../superpowers/plans/2026-08-13-codebase-audit-remediation.md#6-未着手の指摘台帳) の台帳に載っている。
...
| [F-44](2026-08-12-codebase-audit-findings.md#f-44)   | 中     | ★PR                   | 同一アドレスの統合で会員の現用アドレスを恒久抑制しない。hash 抑制にリセット経路と可視化を与えた  | —                                                                                           |
...
| [F-112](2026-08-12-codebase-audit-findings.md#f-112) | 低     | ★PR                   | 匿名化した placeholder を送信対象外にし、リマインダ cron の母集合からも外す                      | —                                                                                           |
