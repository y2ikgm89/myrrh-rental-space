...
**高 11 件は全件クローズ。**残りは中 42 件・低 55 件で、[計画書 §6](../superpowers/plans/2026-08-13-codebase-audit-remediation.md#6-未着手の指摘台帳) の台帳に載っている。
...
| [F-117](2026-08-12-codebase-audit-findings.md#f-117) | 低     | ★PR                   | ゲスト問い合わせの backfill を削除（実効が管理者の解除を打ち消すことだけになっていた）           | —                                                                                           |
