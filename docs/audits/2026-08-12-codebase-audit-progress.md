...
**高 11 件は全件クローズ。**残りは中 54 件・低 58 件で、[計画書 §6](../superpowers/plans/2026-08-13-codebase-audit-remediation.md#6-未着手の指摘台帳) の台帳に載っている。
...
| [F-50](2026-08-12-codebase-audit-findings.md#f-50) | 中     | ★PR                   | 管理画面が読む返金累計から failed / canceled を除外（ドメイン・DB と同じ SSoT を使う）           | —                                                                                           |
