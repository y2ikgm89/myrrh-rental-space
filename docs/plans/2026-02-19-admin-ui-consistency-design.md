...
export function XxxTable({ items }: Props) {
  if (items.length === 0) {
    return (
      <EmptyState
        message="..."
        action={{ label: "新規作成", href: "/admin/xxx/new" }}
      />
    );
  }
...
**新規作成 (8ファイル):** 12. `staff/_components/StaffStats.tsx` 13. `staff/_components/StaffFilters.tsx` 14. `staff/_components/StaffTable.tsx` 15. `staff/_components/InvitationTable.tsx` 16. `audit-logs/_components/AuditLogStats.tsx` 17. `audit-logs/_components/AuditLogTable.tsx`
