...
export function middleware(request: NextRequest) {
  ...
  if (resolvedPath.type === 'blog') {
    return NextResponse.rewrite(new URL(`/blog/${resolvedPath.slug}`, request.url))
  }
  // ...
}
```
...
export function getBlogPostUrl(post: { slug: string; publishedAt: Date; category: { slug: string } }) {
