...
export function createFailure(error: string, fieldErrors?: Record<string, string[]>): ActionFailure
...
export function parseStringArrayOrNull(value: Prisma.JsonValue): string[] | null
export function parseBusinessHours(value: Prisma.JsonValue): BusinessHours | null
```
