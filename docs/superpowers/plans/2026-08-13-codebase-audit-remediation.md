...
| [F-24](../../audits/2026-08-12-codebase-audit-findings.md#f-24)   | 中     | `src/app/(admin)/admin/(dashboard)/_shared/actions/smart-lock-devices.ts:107`                                 | デバイス編集フォームから isActive=false にしてもパスコードが失効しない（トグル経路だけが失効する）                                                              |
| [F-25](../../audits/2026-08-12-codebase-audit-findings.md#f-25)   | 中     | `src/app/(admin)/admin/(dashboard)/_shared/actions/space-smart-lock-devices.ts:49`                            | スペースの Pad 付け替えで、旧デバイスのパスコードが失効されないまま新デバイス分も発行されない                                                                   |
