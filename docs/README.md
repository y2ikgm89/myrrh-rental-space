...
| [`runbooks/post-deploy-verification.md`](runbooks/post-deploy-verification.md)   | デプロイ後の実行時検証（CF `/feed.xml` / Stripe test refund / SwitchBot B-2 / origin secret 旧 version） |
