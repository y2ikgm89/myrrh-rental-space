---
name: type-safety
description: Use when changing TypeScript strictness, Zod schemas, Conform field typing, Prisma JSON handling, generated Prisma types/enums, casts/assertions, validation helpers, or architecture tests that guard type safety in this repository.
---
...
4. Use existing helpers for Prisma JSON conversion and Conform generic
   invariance. Do not scatter caller-side casts.
