...
7. Do not keep compatibility branches for retired schema shapes unless the user explicitly asks for a migration period.
...
- Do not run destructive migrations or broad data cleanup without explicit user approval.
