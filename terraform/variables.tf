...
variable "cloud_run_secret_versions" {
  ...
  default = {
    ...
    # RESEND_WEBHOOK_SECRET は 3-phase secret rollout の Phase A 状態のためここに
    # 入れない (Cloud Run env に version=1 を bind すると operator が
    # `gcloud secrets versions add` を実行するまで
