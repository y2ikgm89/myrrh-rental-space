...
import { GET } from "@/app/(public)/apple-icon/route";

describe("GET /apple-icon", () => {
  beforeEach(() => {
  ...
  test("falls back when favicon URL is unset", async () => {
    mockGetFaviconUrl.mockResolvedValueOnce("");
