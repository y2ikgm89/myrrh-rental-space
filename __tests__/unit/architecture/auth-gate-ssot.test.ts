...
const CUSTOMER_LEGACY_SESSION_IMPORT_ALLOWLIST = new Set([
  ...
  "src/app/(public)/mypage/events/[id]/page.tsx",
  ...
  "src/app/(public)/mypage/receipts/page.tsx",
...
const ADMIN_LEGACY_PAGE_AUTH_IMPORT_ALLOWLIST = new Set([
  ...
  "src/app/(admin)/admin/(dashboard)/settings/appearance/page.tsx",
  "src/app/(admin)/admin/(dashboard)/settings/billing/page.tsx",
  "src/app/(admin)/admin/(dashboard)/settings/business/page.tsx",
  "src/app/(admin)/admin/(dashboard)/settings/features/page.tsx",
  "src/app/(admin)/admin/(dashboard)/settings/integrations/page.tsx",
  "src/app/(admin)/admin/(dashboard)/settings/notifications/page.tsx",
