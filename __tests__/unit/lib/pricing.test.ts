...
// バリデーションヘルパー
//
// calculateReservationPrice（メイン統合関数）の専用テストは
// __tests__/unit/lib/pricing/reservation.test.ts に一本化済み（旧: 本ファイルに
// 重複していたブロックを削除。basePrice + totalHours 受け取り形への signature 変更
// により、35 件の同等カバレッジ込みで移行先が最新化されている）。
// =============================================================================
