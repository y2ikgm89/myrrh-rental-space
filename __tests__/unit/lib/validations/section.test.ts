...
describe('heroConfigSchema', () => {
  test('有効なデータでバリデーション成功', () => {
    const data = {
      ...
      buttons: [
        { text: 'ボタン1', url: '/test', variant: 'primary', size: 'lg', openInNewTab: false },
      ],
      height: 'lg',
      overlay: true,
      overlayOpacity: 50,
...
describe('galleryConfigSchema', () => {
  test('有効なデータでバリデーション成功', () => {
    const data = {
      images: [
        { url: 'https://example.com/1.jpg', alt: '画像1', caption: 'キャプション1' },
...
describe('型ガード関数', () => {
  test('isHeroConfig', () => {
    const validHero = { height: 'md', overlay: true, overlayOpacity: 40, variant: 'default', parallaxSpeed: 0.5, buttons: [] }
  ...
  test('isCtaConfig', () => {
    const validCta = { title: 'CTA', buttons: [], variant: 'default', sectionLabel: 'Ready to Begin?' }
