...
describe('Settings Other Admin Action Integration', () => {
  ...
  describe('maintenanceSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = maintenanceSettingsSchema.safeParse(VALID_MAINTENANCE_INPUT)
  ...
  describe('cookieConsentSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = cookieConsentSettingsSchema.safeParse(VALID_COOKIE_CONSENT_INPUT)
        expect(result.success).toBe(true)
      })
  ...
  describe('termsAgreementSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = termsAgreementSettingsSchema.safeParse(VALID_TERMS_AGREEMENT_INPUT)
        expect(result.success).toBe(true)
      })
    })
  ...
  describe('reservationSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = reservationSettingsSchema.safeParse(VALID_RESERVATION_INPUT)
        expect(result.success).toBe(true)
      })
  ...
  describe('announcementBarCarouselSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = announcementBarCarouselSettingsSchema.safeParse(VALID_ANNOUNCEMENT_BAR_INPUT)
        expect(result.success).toBe(true)
      })
  ...
  describe('robotsTxtSettingsSchema バリデーション', () => {
    describe('正常系', () => {
      test('有効なデータはバリデーション通過', () => {
        const result = robotsTxtSettingsSchema.safeParse(VALID_ROBOTS_TXT_INPUT)
        expect(result.success).toBe(true)
      })
