/**
 * ブログ Public Action 統合テスト
 *
 * src/app/(public)/_shared/actions/blog.ts のテスト
 *
 * バリデーションとオプション処理のテスト
 */
...
// =============================================================================
// GetPublishedBlogPostsOptions Tests
// =============================================================================

describe('Blog Public Action Integration', () => {
  describe('GetPublishedBlogPostsOptions', () => {
  ...
  describe('PublicBlogPost type validation', () => {
    test('有効なブログ記事データ構造', () => {
      const post = {
        id: 'post-123',
        title: 'テスト記事',
