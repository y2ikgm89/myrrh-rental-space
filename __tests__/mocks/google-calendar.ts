 ...
 * 更新されたイベントを記録する配列
 */
export const updatedEvents: { eventId: string; event: Partial<MockCalendarEvent> }[] = []
...
export const mockEventsInsert = mock<
  (params: { calendarId: string; requestBody: Partial<MockCalendarEvent> }) => Promise<MockCalendarInsertResult>
>((params) => {
...
export const mockEventsUpdate = mock<
  (params: { calendarId: string; eventId: string; requestBody: Partial<MockCalendarEvent> }) => Promise<MockCalendarInsertResult>
>((params) => {
...
export const mockEventsList = mock<
  (params: { calendarId: string; timeMin?: string; timeMax?: string }) => Promise<{ data: { items: MockCalendarEvent[] } }>
>(() => {
 ...
 * 更新されたイベントを取得
 */
export function getUpdatedEvents(): { eventId: string; event: Partial<MockCalendarEvent> }[] {
