...
import { getPublishedBlogPosts } from '@/public/actions/blog'
import { cn } from '@/shared/lib/utils'
import type { BlogConfig } from '@/shared/lib/validations/homepage-section'
import type { ReactElement } from 'react'

const blogSectionVariants = tv({
  slots: {
...
const styles = blogSectionVariants()
...
export async function BlogSectionRenderer({
  title: customTitle,
  config,
}: BlogSectionRendererProps): Promise<ReactElement | null> {
