...
import { createSuccess, createFailure, withPermission, withRole, type ActionResult } from '@/types'
import { getSession, getRoleFromSession, type User } from '@/lib/auth'
import { hasPermission, canAccessAdmin } from '@/lib/permissions'
import { logRoleChange, logPermissionDenied } from '@/lib/audit'
