...
/** 全 32 エントリの key 列挙。`as const` で literal tuple として固定。 */
...
export const EMAIL_TEMPLATE_INDEX: ReadonlyArray<EmailTemplateIndexItem> = [
  ...
  {
    key: "reservation-refund",
    label: "予約返金のお知らせ",
    description:
      "管理者が予約の返金 (全額 / 一部) を実行した時にお客様へ送信。",
    category: "reservation",
  },
  {
  ...
  },
  {
    ...
    label: "領収書発行通知",
    description:
      "入金確定後の領収書新規発行時にお客様（ゲスト・会員）へ送信。CTA は予約/申込詳細ページ。",
    category: "reservation",
  },
  {
    key: "receipt-resend",
  ...
  {
    key: "bulk-reservation-cancelled",
    label: "定期予約一括キャンセル",
    description:
      "定期予約（series）の一部/全部が一括キャンセルされた時にお客様・管理者へ送信（Phase B.2）。",
    category: "reservation",
  },
  {
    key: "bulk-reservation-cancelled-admin",
    label: "定期予約一括キャンセル（管理者）",
    description:
      "series 一括キャンセル時の管理者通知。顧客向け bulk と同一テンプレートを registry 上別 key で登録。",
    category: "reservation",
  },
  {
  ...
  },
  {
    ...
    label: "イベント一斉配信",
    description:
      "管理者が任意の件名・本文で申込済み参加者全員へ送信するお知らせメール (T12)。",
    category: "event",
  },
  {
    key: "event-reminder",
  ...
  {
    key: "inquiry-customer-reply-admin",
    label: "お問い合わせ続報（管理者）",
    description:
      "会員がマイページから追加メッセージを送信した時に管理者へ送信。",
    category: "inquiry",
  },
  {
  ...
  {
    key: "customer-broadcast",
    label: "顧客一斉配信",
    description:
      "管理者が任意の件名・本文で選択した顧客（メルマガ受信可 = marketingOptIn: true の顧客のみ）へ送信するお知らせメール（Phase 4）。",
    category: "account",
  },
  {
    key: "review-reply",
