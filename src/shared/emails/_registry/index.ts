...
import { customerBroadcastFixture } from "@/shared/emails/customer-broadcast.fixture";
...
import { eventBroadcastFixture } from "@/shared/emails/event-broadcast.fixture";
...
export const EMAIL_TEMPLATE_REGISTRY = {
  ...
  "reservation-refund": defineEntry(
    "reservation-refund",
    ReservationRefundEmail,
  ...
  "receipt-issued": defineEntry(
    "receipt-issued",
    ReceiptIssuedEmail,
    receiptIssuedFixture,
  ),
  ...
  "event-broadcast": defineEntry(
    "event-broadcast",
    EventBroadcastEmail,
    eventBroadcastFixture,
  ),
  ...
  "customer-merge-verification": defineEntry(
    "customer-merge-verification",
    CustomerMergeVerificationEmail,
    customerMergeVerificationFixture,
  ),
  "customer-broadcast": defineEntry(
    "customer-broadcast",
    CustomerBroadcastEmail,
    customerBroadcastFixture,
  ),
