  ...
  result: {
    reservation: {
      ...
      couponDiscountAmount: {
        ...
        compute(reservation) {
          return reservation.couponDiscountAmount ? Number(reservation.couponDiscountAmount) : null
        },
      },
      durationDiscountAmount: {
        needs: { durationDiscountAmount: true },
        compute(reservation) {
          return reservation.durationDiscountAmount ? Number(reservation.durationDiscountAmount) : null
        },
      },
      spaceDiscountAmount: {
        needs: { spaceDiscountAmount: true },
        compute(reservation) {
          return reservation.spaceDiscountAmount ? Number(reservation.spaceDiscountAmount) : null
        },
      },
      taxRate: {
        needs: { taxRate: true },
      ...
      totalPriceWithTax: {
        ...
        compute(reservation) {
          return reservation.totalPriceWithTax ? Number(reservation.totalPriceWithTax) : null
        },
      },
    },
    space: {
    ...
    coupon: {
      ...
      minReservationAmount: {
        ...
        compute(coupon) {
          return coupon.minReservationAmount ? Number(coupon.minReservationAmount) : null
        },
      },
      maxDiscountAmount: {
