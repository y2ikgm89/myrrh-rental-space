...
export const SITE_WIDTH_PRESETS: Record<LayoutWidth, WidthPreset> = {
  ...
  [LayoutWidth.XL]: { label: '特大', description: 'エクストラワイド', px: 1400 },
  [LayoutWidth.FULL]: { label: '全幅', description: '画面幅いっぱい', px: null },
  [LayoutWidth.CUSTOM]: { label: 'カスタム', description: '任意の幅を指定', px: null },
}
...
export const CONTENT_WIDTH_PRESETS: Record<LayoutWidth, WidthPreset> = {
  ...
  [LayoutWidth.XL]: { label: '特大', description: '画像・ギャラリー向け', px: 1024 },
  [LayoutWidth.FULL]: { label: '全幅', description: '画面幅いっぱい', px: null },
  [LayoutWidth.CUSTOM]: { label: 'カスタム', description: '任意の幅を指定', px: null },
}
