 ...
 * - 民法（改正民法 548 条の 2〜4 定型約款規定 / 成年年齢 18 歳）
 * - 旅館業法（宿泊禁止条項の根拠）
 * - 特定電子メール法
 *
 * ## 外部サービス記載方針
...
<p>事業者名：${PLACEHOLDER.businessName}<br>
代表者：${PLACEHOLDER.representativeName}<br>
所在地：${PLACEHOLDER.address}<br>
...
<ul>
<li>会員情報：退会後 1 年間（法令上の保存義務がある場合はその期間）</li>
<li>予約・取引履歴：取引完了後 7 年間（法人税法・消費税法に基づく保存義務）</li>
<li>お問い合わせ記録：対応完了後 3 年間</li>
<li>アクセスログ：取得後 1 年間</li>
</ul>
...
<p>ブラウザの設定によりCookieの受け入れを拒否することができますが、その場合、一部の機能がご利用いただけなくなることがあります。</p>

<h2>13. 開示・訂正・利用停止等の請求</h2>
<ol>
<li>利用者は、当社が保有する自己の個人情報について、開示、訂正、追加、削除、利用の停止、第三者提供の停止、利用目的の通知を請求することができます。</li>
<li>請求は、第 1 条記載の連絡先までお申し出ください。ご本人であることを確認のうえ、法令に定める期間内に対応いたします。</li>
...
<li>支払遅延が発生した場合、法定利息（年 3%、令和 2 年 4 月改正民法）による遅延損害金を申し受けます。</li>
</ol>
...
<ul>
<li><strong>★★★★★（5）</strong>：期待を上回る優れた体験だった</li>
<li><strong>★★★★☆（4）</strong>：期待通り、または期待以上で満足できた</li>
<li><strong>★★★☆☆（3）</strong>：期待通りで普通</li>
<li><strong>★★☆☆☆（2）</strong>：期待を下回ったが、利用自体は可能だった</li>
<li><strong>★☆☆☆☆（1）</strong>：期待を大きく下回り、重大な問題があった</li>
</ul>
...
<li>第三者の権利を侵害するレビューについて削除を希望される場合は、第 1 条記載の連絡先までご連絡ください。合理的な期間内に確認のうえ、対応いたします。</li>
</ol>
...
<h2>4. 第三者が設置する Cookie</h2>
<p>本サービスでは、以下の第三者サービスが Cookie を設置する場合があります。各サービスの Cookie 利用については、各事業者のプライバシーポリシーをご確認ください。</p>
<ul>
<li><strong>Google Analytics</strong>（Google LLC）：https://policies.google.com/technologies/cookies</li>
<li><strong>Cloudflare Turnstile</strong>（Cloudflare, Inc.）：https://www.cloudflare.com/cookie-policy/</li>
<li><strong>Google Maps</strong>（Google LLC）：https://policies.google.com/technologies/cookies</li>
<li><strong>Stripe</strong>（Stripe, Inc.）：https://stripe.com/jp/cookies-policy/legal</li>
</ul>
