...
/** 画像アスペクト比 */
export const imageAspectValues = ['original', '16:9', '4:3', '3:2', '1:1', '4:5'] as const
...
/** Features レイアウト */
export const featuresLayoutValues = ['hero-first', 'equal-grid', 'icon-left'] as const
...
/** ヒーローバリエーション */
export const heroVariantValues = ['default', 'minimal', 'split', 'video', 'parallax'] as const
...
/** お問い合わせ バリエーション */
export const contactFormVariantValues = ['default', 'minimal', 'split'] as const
...
export const galleryImageAspectValues = ['original', '4:3', '1:1', '16:9'] as const
