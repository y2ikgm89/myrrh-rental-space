"use client";
/**
 * SpaceListSimpleView — grid / list / carousel variants
 *
 * Configurable columns / layout variant / "view all" link with useGSAP
 * stagger animation. Used by SpaceListSection when displayLayout is not
 * "catalog".
 */
...
interface SpaceListSimpleViewProps {
  readonly config: SpaceListConfig;
  readonly spaces: readonly SpaceListData[];
  readonly style: SectionStylePayload;
}

export function SpaceListSimpleView({
  config,
  spaces,
  style,
}: SpaceListSimpleViewProps): ReactElement {
