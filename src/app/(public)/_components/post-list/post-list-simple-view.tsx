...
/**
 * PostListSimpleView — grid / list variants
 *
 * Card grid with thumbnail + category badge + title + excerpt, with useGSAP
 * stagger entrance animation. Used by PostListSection when displayLayout is
 * not "archive".
 */
...
interface PostListSimpleViewProps {
  readonly config: PostListConfig;
  readonly posts: readonly PostData[];
  readonly style: SectionStylePayload;
}

export function PostListSimpleView({
  config,
  posts,
  style,
}: PostListSimpleViewProps): ReactElement {
