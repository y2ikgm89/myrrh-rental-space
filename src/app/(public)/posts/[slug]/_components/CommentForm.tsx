...
import { createComment } from '@/public/actions/post-comment'
...
export function CommentForm({
  ...
  // Turnstileが必要かどうか（ゲストの場合のみ、Site Keyが設定されている場合）
  const needsTurnstile = !isLoggedIn && Boolean(turnstileSiteKey)
