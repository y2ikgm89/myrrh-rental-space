...
export const GALLERY_HOVER_EFFECT_MAP: Record<GalleryHoverEffect, { wrapper: string; overlay: string }> = {
  zoom: { wrapper: 'group overflow-hidden', overlay: '' },
  overlay: { wrapper: 'group overflow-hidden', overlay: 'opacity-0 group-hover:opacity-100 transition-opacity' },
...
/** デフォルトのカードグリッド列クラス */
export const DEFAULT_CARD_GRID_COLS = 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'
...
/** デフォルトのギャラリーグリッド列クラス */
export const DEFAULT_GALLERY_GRID_COLS = 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'
