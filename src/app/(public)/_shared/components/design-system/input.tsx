      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            "w-full min-h-11 border-0 border-b bg-transparent py-3 text-base md:text-sm text-foreground transition-colors placeholder:text-muted-foreground-subtle focus-visible:border-accent disabled:opacity-50 disabled:cursor-not-allowed",
