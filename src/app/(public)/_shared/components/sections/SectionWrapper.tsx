 ...
 */
export function getTitleStyle(design: SectionDesign): React.CSSProperties | undefined {
 ...
 */
export function getTextStyle(design: SectionDesign): React.CSSProperties | undefined {
