 ...
 */
function detectGpuTierFromWebGL(): { tier: 0 | 1 | 2 | 3; isMobile: boolean; gpu: string | null } {
  ...
  // 専用 GPU キーワード検出
  const isDedicatedGpu = gpu !== null && /NVIDIA|Radeon|GeForce|RTX|GTX|RX\s?\d/i.test(gpu)
