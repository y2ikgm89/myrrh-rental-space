        ...
        {formData.enabled && (
          <>
            ...
            <div className="space-y-4">
              ...
              {/* ポーリング間隔 */}
              {(formData.syncMethod === CalendarSyncMethod.polling || formData.syncMethod === CalendarSyncMethod.both) && (
                <div className="space-y-2">
                  <Label>ポーリング間隔</Label>
                  <Select
            ...
            {/* Webhook設定 */}
            {(formData.syncMethod === CalendarSyncMethod.webhook || formData.syncMethod === CalendarSyncMethod.both) && (
