...
import { createTermsWithVersion, updateTerms, updateTermsVersion, deleteTerms, getDefaultsForTermsType } from '@/admin/actions/terms'
import {
  Button,
  Dialog,
  DialogContent,
...
import { getTemplatesForType, applyBusinessInfo, type BusinessInfo } from '@/shared/lib/terms-templates'
...
export function TermsInlineEditor({ terms, businessInfo, mode = 'edit' }: TermsInlineEditorProps) {
