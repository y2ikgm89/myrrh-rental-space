...
import type { CollapsibleStyle, CollapsibleRadius, CollapsibleTitleColor } from '../nodes/CollapsibleContainerNode'
...
export const COLLAPSIBLE_TITLE_COLOR_LABELS: Record<CollapsibleTitleColor, string> = {
  default: 'デフォルト',
  primary: 'プライマリ',
  muted: 'ミュート',
  info: '情報',
