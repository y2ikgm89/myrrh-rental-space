...
export const STRUCTURE_INSERT_ITEMS: readonly InsertItem[] = [
  ...
  },
  {
    ...
    label: "見出し5",
    icon: IconH5,
    keywords: ["heading", "h5", "midashi"],
    category: "basic",
    showInToolbar: false,
    showInPicker: true,
    applyInUpdate: () => applySetBlocksType(() => $createHeadingNode("h5")),
  },
  {
    id: "h6",
    type: "transform",
    label: "見出し6",
    icon: IconH6,
    keywords: ["heading", "h6", "midashi"],
    category: "basic",
    showInToolbar: false,
    showInPicker: true,
    applyInUpdate: () => applySetBlocksType(() => $createHeadingNode("h6")),
  },
  {
    id: "quote",
    type: "transform",
  ...
  },
  {
    ...
    keywords: ["ruby", "furigana", "ルビ", "ふりがな", "annotation"],
    category: "widget",
    showInToolbar: true,
    showInPicker: true,
    dialogId: "ruby",
  },
  {
    ...
    label: "ツールチップ",
    icon: IconInfoCircle,
    keywords: ["tooltip", "hint", "ツールチップ", "説明", "hover"],
    category: "widget",
    showInToolbar: true,
    showInPicker: true,
    dialogId: "tooltip",
