...
export function MobileEditorFallback({ contentHtml, height = '300px' }: MobileEditorFallbackProps) {
  return (
    <div className="flex flex-col" style={{ height }}>
      ...
      <div className="flex flex-col items-center justify-center gap-3 p-6 border-b border-border">
        ...
        <div className="text-center space-y-1">
          <p className="text-sm font-medium text-foreground">デスクトップ環境でご利用ください</p>
      ...
      {contentHtml && (
        <div className="flex-1 overflow-y-auto p-4">
          <p className="text-xs text-muted-foreground mb-2">現在のコンテンツ（読み取り専用）:</p>
