...
> = {
  yellow: { label: "黄色", value: "rgba(255, 235, 59, 0.4)" },
  green: { label: "緑", value: "rgba(76, 175, 80, 0.4)" },
  blue: { label: "青", value: "rgba(33, 150, 243, 0.4)" },
  pink: { label: "ピンク", value: "rgba(233, 30, 99, 0.4)" },
  orange: { label: "オレンジ", value: "rgba(255, 152, 0, 0.4)" },
  purple: { label: "紫", value: "rgba(156, 39, 176, 0.4)" },
};
    ...
    if ($isRangeSelection(selection)) {
      if (color === "none") {
        ...
        $patchStyleText(selection, {
          "background-color": HIGHLIGHT_COLORS[color].value,
        });
      }
    }
  });
