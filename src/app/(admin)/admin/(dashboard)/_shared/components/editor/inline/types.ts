...
} as const satisfies { [K in keyof PostPublishFormFields]-?: Path<PostEditorFormData> }
...
} & SEOFormFields & OGPFormFields & PostPublishFormFields
...
export const NEWS_PUBLISH_FIELDS = {
  ...
  publishedAt: 'publishedAt',
} as const satisfies { [K in keyof PublishFormFields]-?: Path<NewsEditorFormData> }
...
export const SPACE_SEO_FIELDS = {
  metaDescription: 'metaDescription',
  metaKeywords: 'metaKeywords',
} as const satisfies { [K in keyof SEOFormFields]-?: Path<SpaceEditorFormData> }
...
export const SPACE_OGP_FIELDS = {
  ...
  ogpDescription: 'ogpDescription',
  ogpImageUrl: 'ogpImageUrl',
} as const satisfies { [K in keyof OGPFormFields]-?: Path<SpaceEditorFormData> }

/** SpaceEditorFormData用の公開設定フィールド名 */
export const SPACE_PUBLISH_FIELDS = {
  isPublished: 'isPublished',
  publishedAt: 'publishedAt',
} as const satisfies { [K in keyof PublishFormFields]-?: Path<SpaceEditorFormData> }
...
export const FAQ_PUBLISH_FIELDS = {
  isPublished: 'isPublished',
  publishedAt: 'publishedAt',
} as const satisfies { [K in keyof PublishFormFields]-?: Path<FaqEditorFormData> }
