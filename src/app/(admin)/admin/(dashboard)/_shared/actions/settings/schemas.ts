...
// 時間帯の重複チェック
function hasOverlappingSlots(slots: Array<{ openTime: string; closeTime: string }>): boolean {
...
export type DurationDiscountRuleInput = z.infer<typeof durationDiscountRuleSchema>
