...
// クーポンステータスフィルターの型定義
const COUPON_STATUS_FILTERS = ['active', 'inactive', 'expired', 'limitReached', 'notStarted'] as const
...
function isValidCouponStatusFilter(value: unknown): value is CouponStatusFilter {
