  ...
  return (
    <div className="overflow-hidden rounded-lg border bg-card">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="hidden w-16 md:table-cell">並び順</TableHead>
            <TableHead>カテゴリー名</TableHead>
            <TableHead className="hidden lg:table-cell">説明</TableHead>
            <TableHead className="hidden w-24 lg:table-cell">アイコン</TableHead>
            <TableHead className="hidden w-24 lg:table-cell">色</TableHead>
            <TableHead className="hidden w-24 text-center md:table-cell">スペース数</TableHead>
