 ...
 * 基本型は@/shared/types/server-actionsからre-export
 * admin固有の認可HOFs（withAuth, withPermission等）を提供
 */
...
import { logUserAction, logPermissionDenied, type AuditUser } from '@/admin/lib/audit'

// Re-export basic types and helpers from shared
export {
  type ActionSuccess,
  type ActionFailure,
  type ActionResult,
...
// Import only what's used internally in this file
import {
  type ActionFailure,
  type ActionResult,
  createFailure,
