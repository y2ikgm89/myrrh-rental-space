...
- [gotchas/ui.md](./gotchas/ui.md) — 公開フォーム UI / 公開ページ レスポンシブ / Page-First Architecture / ブログサイドバー
...
- [gotchas/claude-code.md](./gotchas/claude-code.md) — Import Alias / shadcn/ui / Route Handler (PPR) / Claude Code 設定
