...
- ~75 件 → Phase 3-A 後 ~85 件 (`as const` / `as unknown` 除外後 ~5-10 件)
- うち上記 ledger の **20 件全て documented exceptions** (`assertion-bans.md` §1-7 + typedRoutes patterns + conform generic invariance)
