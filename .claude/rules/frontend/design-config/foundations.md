...
| Hero                              | ホーム: `pageHero.variant`（editorial-split / compact / minimal / video）。旧 `homepage-hero` Section は廃止。video は R2 / YouTube / Vimeo 背景動画 + overlay テキスト（2026-05-24 PR #214）                                                                                                                                                                                                                                                                                                               |
