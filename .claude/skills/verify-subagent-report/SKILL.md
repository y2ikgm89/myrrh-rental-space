...
- `.claude/rules/claude-code-patterns.md` — subagent 検証規律・haiku ban
- `.claude/hooks/post-subagent-git-snapshot.sh` — Agent tool（v2.1.63 で Task から rename）実行後の自動 git state スナップショット
