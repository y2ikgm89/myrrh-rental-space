...
- L1: `.claude/rules/visual-effects-patterns.md` (CSSエフェクトカタログ)
- L2: `.claude/rules/gsap-patterns.md`
- L3: `.claude/rules/threejs-patterns.md`
- L4: `.claude/rules/pixijs-patterns.md`
